...
const authItem = Joi.object({
  password: Joi.string().min(6).max(120).optional(),
  passwordAutoGenerated: Joi.boolean().optional(),
  requirePasswordReset: Joi.boolean().optional(),
  lastPasswordUpdatedAt: Joi.date().optional(),
});
...
const createConsultantSchema = Joi.object({
  ...
  autoGeneratedPassword: Joi.boolean().optional(),
  passwordUpdatedAt: Joi.date().optional(),
  resetPasswordToken: Joi.string().allow("").max(128).optional(),
  resetPasswordExpires: Joi.date().optional(),
  lastLogin: Joi.date().optional(),
  passwordHash: Joi.string().min(6).max(128).optional(),
  autoGeneratedPassword: Joi.boolean().optional(),
  passwordUpdatedAt: Joi.date().optional(),
  resetPasswordToken: Joi.string().allow("").max(128).optional(),
  resetPasswordExpires: Joi.date().optional(),
